...
export default function Events() {
  ...
  useEffect(() => {
    // If currentPage is out of bounds after filtering, reset to last valid page
        ...
        {paginatedEvents.length > 0 ? (
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
            {paginatedEvents.map((event) => (
              <div
                key={event.id}
                className="bg-[#0000001A] rounded-xl overflow-hidden shadow-lg flex flex-col group"
              >
                <div className="relative h-48">
                  <div
                    className="absolute inset-0 z-0"
                    style={{
                      background: `linear-gradient(0deg, rgba(0,0,0,0.5) 0%, rgba(0,0,0,0.5) 100%), url(${event.imageUrl}) center/cover no-repeat`,
                    }}
                  />
                  ...
                  <div className="absolute bottom-4 left-4  p-2 rounded-lg flex items-center space-x-2 text-sm z-10">
                ...
                <div className="p-5 flex flex-grow items-center">
                  ...
                  <div className="flex items-center justify-end  space-x-2">
                    <button
                      ...
                      className=" p-1   rounded-[31px] border border-[#C267FF] transition-colors duration-200"
                    >
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        width="25"
                    ...
                    <button
                      ...
                      className="p-2 border border-[#FF0000] rounded-[31px] hover:bg-red-600 transition-colors duration-200"
                    >
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        width="16"
                      ...
                      >
                        <path
                          d="M6.9292 9.69482L6.9292 7.82514"
                          stroke="#FF0000"
                          stroke-width="1.24645"
                          stroke-linecap="round"
                        />
                        <path
                          d="M9.42188 9.69482L9.42187 7.82514"
                          stroke="#FF0000"
                          stroke-width="1.24645"
                          stroke-linecap="round"
                        />
                        <path
                          d="M2.56641 4.70898H13.7845V4.70898C13.2037 4.70898 12.9133 4.70898 12.6843 4.80387C12.3789 4.93037 12.1362 5.17302 12.0097 5.47844C11.9148 5.7075 11.9148 5.99789 11.9148 6.57867V10.318C11.9148 11.4932 11.9148 12.0808 11.5497 12.4459C11.1847 12.8109 10.5971 12.8109 9.4219 12.8109H6.92899C5.75383 12.8109 5.16624 12.8109 4.80117 12.4459C4.43609 12.0808 4.43609 11.4932 4.43609 10.318V6.57866C4.43609 5.99789 4.43609 5.7075 4.34121 5.47844C4.2147 5.17302 3.97205 4.93037 3.66663 4.80387C3.43757 4.70898 3.14718 4.70898 2.56641 4.70898V4.70898Z"
                          stroke="#FF0000"
                          stroke-width="1.24645"
                          stroke-linecap="round"
                        />
                        <path
                          d="M6.97144 2.44678C7.04246 2.38052 7.19894 2.32197 7.41663 2.28021C7.63431 2.23846 7.90103 2.21582 8.17542 2.21582C8.44981 2.21582 8.71653 2.23846 8.93421 2.28021C9.1519 2.32197 9.30839 2.38052 9.3794 2.44678"
                          stroke="#FF0000"
                          stroke-width="1.24645"
                          stroke-linecap="round"
                        />
