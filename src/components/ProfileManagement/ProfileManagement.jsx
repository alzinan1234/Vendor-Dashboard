    ...
    <div className="min-h-screen bg-[#343434] text-white p-8 font-sans  rounded-lg ">
      <div className=" p-6 ">
        ...
        <div className="flex flex-col  gap-6 mb-8">
          {/* Image Section */}
          <div className="relative w-[349px]  h-[222px]  overflow-hidden ">
            ...
            <Image
              ...
              height={222}
            />
            <div className="absolute top-3 right-3 border bg-opacity-75 rounded-full p-2 cursor-pointer">
              <svg
          ...
          <div className="">
            ...
            <ul className="list-disc list-inside text-gray-300 mt-6 space-y-2">
              ...
              <li>
                NikoSafe Verified: Scan QR for Safe Entry - Certified by xxxx
              </li>
